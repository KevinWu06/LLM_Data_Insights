...
import useBannerImageMapServier from '../BannerVisuals/excel_banner_images_servier'
...
export default function TableauEmbedServier({ selectedCheckboxes, setSelectedCheckboxes, style }) {
